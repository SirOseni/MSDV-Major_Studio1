...
names.push(newName);
URLs[URLs.length] = newURL; // This adds the newURL to the array.
years = years.concat([newYear]); // concat combines arrays, if var is a single value, add the ([]).
...
names.forEach(function(n,i) {
  ...
  museums2[n]["year"] = currentYear;   // Both currentURL & currentYear formulas serve the same purpose. Option A is for single connected text. Option B is for more open ended inputs
});
...
addAMuseum(museums2,"American Museum of Natural History", "amnh.org", 1869);
