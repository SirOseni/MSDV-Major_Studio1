...
d3.csv('data/prices.csv').then((data) => {
    ...
    data.forEach(function(n){
        n.month = parseDate(n.month); // what does this do? 'This sorts out the month on the data
        n.price = Number(n.price.trim().slice(1)); // what does this do? 'Removes the space and selects the text after the first letter
    })
