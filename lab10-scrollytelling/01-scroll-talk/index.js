...
d3.json("./jabberwocky.json").then(data => {
  ...
  function position() {
    var pos = window.scrollY - 10;    //Vertical scrolling medium
    var sectionIndex = d3.bisect(sectionPositions, pos);
    sectionIndex = Math.min(section.size() - 1, sectionIndex); //Ensures that the section index isn't greater than the size of the section of the scrolled past.
